...
from modules.gui_components import create_menu, create_layers_ui
from modules.view import build_view
...
class ImageProcessorApp:
    ...
    def create_widgets(self):
        # Nutze die View, um das Layout zu erstellen – hier kannst du das Aussehen anpassen
        widgets = build_view(self.root, self.show_left_preview)
        self.main_frame = widgets["main_frame"]
        self.top_frame = widgets["top_frame"]
        self.preview_frame = widgets["preview_frame"]
        self.slider_frame = widgets["slider_frame"]
        self.left_canvas = widgets.get("left_canvas")  # kann None sein, wenn linke Vorschau deaktiviert
        self.right_canvas = widgets["right_canvas"]
        self.filename_label = widgets["filename_label"]
        self.settings_label = widgets["settings_label"]
    ...
    def run_ocr(self):
        # OCR wird auf dem bearbeiteten (rechten) Bild ausgeführt.
        run_ocr_op(self)
